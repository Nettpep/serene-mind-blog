      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="w-full md:w-auto p-8 bg-zen-bg rounded-2xl">
            <h5 className="text-zen-text font-serif text-lg mb-2">จดหมายข่าวรายสัปดาห์</h5>
            <p className="text-zen-text/50 text-xs mb-6">รับบทความเตือนสติและกำลังใจส่งตรงถึงอีเมลของคุณ</p>
